...
# Frame dimensions (3 levels only)
num_levels = 3  # Number of shelves
...
# Combine all parts
frame_3level = trimesh.util.concatenate(parts)

# Export frame to STL
frame_output = '/home/roplming/rpmws/src/bookrobot/bookrobot_gazebo/models/bookshelf/frame_3level.stl'
frame_3level.export(frame_output)
print(f"3-level frame STL exported to: {frame_output}")
print(f"Frame vertices: {len(frame_3level.vertices)}, Faces: {len(frame_3level.faces)}")
